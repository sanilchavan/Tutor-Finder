<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="newproject1.Signup" %>
...
<body>
    ...
    <div class="row">
      ...
      <div class="col" controltovalidate="contact">
          <asp:Label ID="Label1" class="label" runat="server" Text="First Name"></asp:Label>
                    ...
                    <asp:Label ID="Label2" class="label" runat="server" Text="Last Name"></asp:Label>
    ...
    Display = "Dynamic" ErrorMessage = "Invalid email address"/>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="email" ForeColor="Red" ErrorMessage="Email  Required"></asp:RequiredFieldValidator>
          ...
          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Contact Required!" ControlToValidate="contact" ForeColor="Red" ></asp:RequiredFieldValidator>
                    <asp:Button ID="Button3" runat="server" class="submitbtn" Text="Signup" OnClick="Button3_Click" />
      ...
      <div class="col">
        <div class="hide-md-lg">
          ...
          <asp:TextBox ID="password"  runat="server"  placeholder="Password" TextMode="Password" ></asp:TextBox>
                                        <asp:Label ID="Label4" class="label" runat="server" Text=" Repeat Password"></asp:Label>
          <asp:TextBox ID="repeat_password"  runat="server"  placeholder="Password" TextMode="Password" ></asp:TextBox>
          ...
          <asp:Label ID="Label8" class="label" runat="server" Text="Location"></asp:Label>
           ...
           <asp:Button ID="Button2" runat="server" class="cancelbtn" Text="Clear" OnClick="Button2_Click"  />
