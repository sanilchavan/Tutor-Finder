<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_view_users.aspx.cs" Inherits="newproject1.admin_view_users" %>
...
<body>
            ...
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="cleverNav">
                   ...
                   <ul>
                                ...
                                <li><a href="admin-index.aspx">For Admin</a>
                                    <ul class="dropdown">
    ...
    <div class="clever-catagory bg-img d-flex align-items-center justify-content-center p-3" style="background-image: url(img/bg-img/bg2.jpg);">
        <h3>Students </h3>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mydbConnectionString1 %>" SelectCommand="SELECT * FROM [Student]" ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [Student] WHERE [s_id] = @original_s_id AND [email] = @original_email AND [password] = @original_password AND [name] = @original_name AND [subjects] = @original_subjects AND [location] = @original_location AND [contact] = @original_contact" InsertCommand="INSERT INTO [Student] ([s_id], [email], [password], [name], [subjects], [location], [contact]) VALUES (@s_id, @email, @password, @name, @subjects, @location, @contact)" OldValuesParameterFormatString="original_{0}" UpdateCommand="UPDATE [Student] SET [email] = @email, [password] = @password, [name] = @name, [subjects] = @subjects, [location] = @location, [contact] = @contact WHERE [s_id] = @original_s_id AND [email] = @original_email AND [password] = @original_password AND [name] = @original_name AND [subjects] = @original_subjects AND [location] = @original_location AND [contact] = @original_contact">
                                    <DeleteParameters>
                                        <asp:Parameter Name="original_s_id" Type="Int32" />
                                        <asp:Parameter Name="original_email" Type="String" />
                                        <asp:Parameter Name="original_password" Type="String" />
                                        <asp:Parameter Name="original_name" Type="String" />
                                        <asp:Parameter Name="original_subjects" Type="String" />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="220px" Width="1423px" CssClass="auto-style1" >
