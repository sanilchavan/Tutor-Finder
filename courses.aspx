<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courses.aspx.cs" Inherits="newproject1.test" %>
...
<body runat="server">
    ...
    <header class="header-area">
        ...
        <div class="clever-main-menu">
            <iv class="classy-nav-container breakpoint-off">
                <!-- Menu -->
    ...
    <div class="clever-catagory bg-img d-flex align-items-center justify-content-center p-3" style="background-image: url(img/bg-img/bg2.jpg);">
        <h3>Courses </h3>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mydbConnectionString1 %>" SelectCommand="SELECT * FROM [Courses]">
                                </asp:SqlDataSource>
                                
          

            <asp:DataList ID="DataList1" runat="server" DataKeyField="Id" DataSourceID="SqlDataSource1" RepeatDirection="Horizontal"  RepeatColumns="3" Width="1350px" Height="143px" CssClass="mr-0" BorderWidth="0px" OnItemCommand="DataList1_ItemCommand"  >
                <ItemTemplate>
                            ...
                            <div class="seat-rating h-100 d-flex align-items-center">
                                <div class="seat">
                                    <asp:Label ID="seats"  class="fa fa-user" runat="server" Text='<%# Eval("c_participants") %>' aria-hidden="true" Height="16px" Font-Size="Small"></asp:Label>
                                     ...
                                     <asp:Label ID="rating"  class="fa fa-star" runat="server" Text='<%# Eval("c_rating") %>' aria-hidden="true" Font-Size="Small"></asp:Label>

                              
                            </div>

                            <div class="course-fee h-100">
                     <asp:Button ID="view_course" runat="server" Text="VIEW " class="btn btn-primary"  CommandName="view_course" CommandArgument='<%#Eval("c_id")+","+ Eval("c_name")+","+ Eval("c_teacher")+","+Eval("c_type")+","+Eval("c_description")+","+Eval("c_rating")+" ,"+Eval("c_fee")+","+Eval("c_participants")%>'  />
                                <asp:Button ID="add_course" runat="server" Text="ADD " class="btn btn-primary"  CommandName="add_course" CommandArgument='<%#Eval("c_id")+","+ Eval("c_name")+","+ Eval("c_teacher")+","+Eval("c_type")+","+Eval("c_description")+","+Eval("c_fee")+" ,"+Eval("c_rating")+","+Eval("c_participants")+","+Eval("image")%>'  />
                                <asp:HyperLink ID="fees1" runat="server" class="free" Text='<%# Eval("c_fee") %>'></asp:HyperLink>
                            </div>
                        </div>
                    </div>
                </div>
