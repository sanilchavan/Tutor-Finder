<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courses1.aspx.cs" Inherits="newproject1.courses1" %>
...
<body>
    ...
    <div class="clever-catagory bg-img d-flex align-items-center justify-content-center p-3" style="background-image: url(img/bg-img/bg2.jpg);">
        <h3>Courses </h3>
            ...
            <asp:DataList ID="DataList1" runat="server" DataKeyField="Id" DataSourceID="SqlDataSource1" RepeatDirection="Horizontal"  RepeatColumns="3" Width="1350px" Height="143px" CssClass="mr-0" BorderWidth="0px" OnSelectedIndexChanged="DataList1_SelectedIndexChanged"  >
                <ItemTemplate>
                   ...
                   <div class="container">
                    ...
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <asp:Image ID="Image1" runat="server" height="275px" ImageUrl='<%# Eval("image") %>' />
