<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="newproject1.index1" %>
                            ...
                            <ul>
                                ...
                                <li><a href="#">For Students</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="courses1.aspx">Courses</a></li>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/physics.jpg" alt="">
                        <!-- Blog Content -->
                        <div class="blog-content">
                            ...
                            <p>This course covers torque, center of mass, rigid bodies in equilibrium, and the stability of objects.   The course is a mix of lectures and problem solving tutorials.   Students will learn to how to calculate torque, how to evaluate the center of mass of systems of particles and objects with uniform density.   </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <img src="img/bg-img/biology.jpg" alt="">
                        <!-- Blog Content -->
                        <div class="blog-content">
                            <a href="#" class="blog-headline">
                                <h4>Chemistry</h4>
                            ...
                            <div class="meta d-flex align-items-center">
                                <a href="#">Thomas Amman</a>
                            </div>
                            <p>This course is a comprehensive introduction to Chemistry, covering everything you will need to know as you prepare for possible future exams.  It doesn't matter how much, or how little, prior knowledge of Chemisty.</p>
                        </div>
                    </div>
                </div>
            </div>
