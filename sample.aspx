<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sample.aspx.cs" Inherits="newproject1.login" %>
    ...
    <div class="row">
        ...
        <input type="text" name="lastname" placeholder="Lastname" required>
          <asp:Label ID="Label5" class="label" runat="server" Text="Email"></asp:Label>
           ...
           <asp:Label ID="Label7" class="label" runat="server" Text="Contact"></asp:Label>
                            <input type="text" name="number" placeholder="987878789" required>
                    <asp:Button ID="Button3" runat="server" class="submitbtn" Text="Signup" />
      ...
      <div class="col">
        ...
        <input type="password" name="password" placeholder="Password" required>
                  ...
                  <input type="password" name=" repeat password" placeholder="Password" required>
          <asp:Label ID="Label6" class="label" runat="server" Text="Subjects"></asp:Label>
                            <input type="text" name="subjects" placeholder="eg. English, Maths, Chemistry" required>
          <asp:Label ID="Label8" class="label" runat="server" Text="Location"></asp:Label>
                            <input type="text" name="location" placeholder="eg. Mumbai[E], Mumbai[W]" required>
