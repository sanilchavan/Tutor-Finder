<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tutor-login.aspx.cs" Inherits="newproject1.tutor_login" %>
...
<body>
  ...
  <form  runat="server">
    <div class="row">
      ...
      <div class="col">
          <a href="tutor_signup.aspx" class="google btn" style="margin-top:60px;height:45px"><i >
          </i> SIGNUP 
        </a>
      </div>
      ...
      <div class="col">
        <div class="hide-md-lg">
          ...
          <asp:TextBox ID="t1" runat="server" type="text" placeholder="username"></asp:TextBox>
          <br />
          <asp:TextBox ID="t2" runat="server" TextMode="Password" placeholder="Password"></asp:TextBox>

          <asp:Button ID="Button1" runat="server" Text="Login" class="submitbtn" OnClick="Button1_Click1" />
          <asp:Button ID="Button2" runat="server" Text="Forget Password?" class="cancelbtn"  />
          <asp:Label ID="wrong" runat="server" Text="" Visible="false" class="label label-warning"></asp:Label>
