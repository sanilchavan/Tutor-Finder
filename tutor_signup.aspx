<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tutor_signup.aspx.cs" Inherits="newproject1.tutor_signup" %>
    ...
    <div class="row">
      ...
      <div class="col">
          ...
          <asp:Label ID="Label5" class="label" runat="server" Text="Email"></asp:Label>
           ...
           <asp:Label ID="Label14" class="label" runat="server" Text="Education"></asp:Label>
                              <asp:TextBox ID="education" runat="server"  placeholder="eg.Bsc,Msc" ></asp:TextBox>
      ...
      <div class="col">
        <div class="hide-md-lg">
          ...
          <asp:Image ID="imgview" runat="server" ImageUrl="~/img/tutor-img/t1.png"  Height="150px" Width="100px"/>
