<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tutors.aspx.cs" Inherits="newproject1.tutors" %>
                ...
                <ItemTemplate>
                   ...
                   <div class="container">
                    ...
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <asp:Image ID="Image1" runat="server" Width="350px" Height="250px" ImageUrl='<%# Eval("image") %>'/>
                        <!-- Course Content col-md-6 col-lg-4-->
                        <div class="course-content">
                            <asp:Label ID="title" runat="server" Text='<%# Eval("name") %>' Font-Size="XX-Large"></asp:Label>

                           
                            <asp:Label ID="desc" runat="server" Text='<%# Eval("description") %>' Font-Size="Small" Height="131px"></asp:Label>
                        </div>
                        <!-- Seat Rating Fee -->
                        <div class="seat-rating-fee d-flex justify-content-between">
                            <div class="seat-rating h-100 d-flex align-items-center">
                                <div class="seat">
                                    <asp:Label ID="seats"  class="fa fa-user" runat="server" Text='<%# Eval("subject") %>' aria-hidden="true" Height="16px" Font-Size="Small"></asp:Label>
                                </div>
                                
                                     <asp:Label ID="rating"  class="fa fa-star" runat="server" Text='<%# Eval("type") %>' aria-hidden="true" Font-Size="Small" ></asp:Label>

                              
                            </div>
                            <div class="course-fee h-100">
                                    <asp:Button ID="add_tutor" runat="server" Text="ADD " class="btn btn-primary" style="width:75px"  CommandName="add_tutor" CommandArgument='<%#Eval("tutor_id")+","+ Eval("image")+","+Eval("name")+","+Eval("description")+","+Eval("fees")+" ,"+Eval("education")+","+Eval("location")%>'   />

                      <asp:Button ID="Button1" runat="server" Text="CONTACT " class="btn btn-primary"  CommandName="contact_tutor"   />
